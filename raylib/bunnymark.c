...
#define MAX_BUNNIES 200000   // 200K bunnies limit
...
int main(void)
{
    ...
    // Load bunny texture
    Texture2D texBunny = LoadTexture("resources/bunnys.png");
    Rectangle rectBunny = { 2, 47, 26, 37 };
    ...
    while (!WindowShouldClose())    // Detect window close button or ESC key
    {
        ...
        BeginDrawing();
            ...
            for (int i = 0; i < bunniesCount; i++)
            {
                ...
                DrawTextureRec(texBunny, rectBunny, bunnies[i].position, bunnies[i].color);
            }
